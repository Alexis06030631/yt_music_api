...
export const DESCRIPTION_PLAYLIST: any[] = ["description", ...DESCRIPTION_SHELF, "description", "runs"];
...
export const ALBUM_SHELF_RENDERER_ARTIST: any[] = [...SINGLE_COLUMN_TAB, ...SECTION_LIST_ITEM, "gridRenderer"];
