...
function Ula(a:any) {
    var b = a.split("")
        , c = [-572808053, 1570750806, -759762889, 425644849, function(d:any, e:any, f:any, h:any, l:any) {
        return e(f, h, l)
    }
        , 1377428663, function(d:any, e:any, f:any) {
            var h = e.length;
            f.forEach(function(l:any, m:any, n:any) {
                this.push(n[m] = e[(e.indexOf(l) - e.indexOf(this[m]) + m + h--) % e.length])
            }, d.split(""))
        }
        , "continue", -654089369, 186576200, -1552778541, -542086212, -1305246054, -755410476, 735227564, -1142141139, -1789747499, 604000267, 90801446, function(d:any) {
            for (var e = d.length; e; )
                d.push(d.splice(--e, 1)[0])
        }
        , -665627445, -1531069327, -572808053, 2001516034, function(d:any) {
            d.reverse()
        }
        , 562338924, 921861718, function(d:any, e:any) {
        ...
        , function(d:any, e:any, f:any, h:any, l:any, m:any) {
            return e(h, l, m)
        }
        , function() {
        ...
        , 628377896, 351903272, 1847165907, -876466524, function(d:any, e:any) {
            if (0 != d.length) {
        ...
        , 1568988749, function(d:any, e:any, f:any, h:any, l:any, m:any, n:any, p:any, q:any) {
            return f(h, l, m, n, p, q)
        }
        , 1264313961, b, 1437243201, 228369387, 158837733, b, -1429679028, 13147348, -461828838, -1142141139, 1222557174, -811642466, -1762897331, -1601424094, ")},,", -1694052193, 211760313, function(d:any, e:any) {
            e = (e % d.length + d.length) % d.length;
            d.splice(-e).reverse().forEach(function(f:any) {
                d.unshift(f)
            })
        }
        , 580546790, 1980808752, 1407991798, 1331836714, 500412256, function(d:any, e:any) {
            0 != e.length && (d = (d % e.length + e.length) % e.length,
                e.splice(0, 1, e.splice(d, 1, e[0])[0]))
        }
        , null, function() {
        ...
        , 344293134, -1443629509, 1388800659, null, 604335048, b, function(d:any, e:any) {
    ...
    try {
        try {
            (-8 <= c[57] || ((0,
                c[28])(c[49],
                c[Number(new Date("1970-01-01T11:16:11.000+11:15")) / 1E3]),
                (0,
                    c[27])(c[41], c[69]),
                0)) && (0,
                c[4])((0,
